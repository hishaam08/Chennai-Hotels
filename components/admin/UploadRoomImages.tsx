...
const UploadRoomImages = ({ data }: Props) => {
  ...
  return (
    <div className="row wrapper">
      <div className="mt-5 col-10 col-lg-7 mt-lg-0">
        <form className="rounded shadow bg-body">
          ...
          <div className="form-group">
                    ...
                    <div className="mt-2 col-md-3">
                      <div className="card">
                        ...
                        <button
                          ...
                          type="button"
                          className="py-0 mt-1 btn btn-block btn-danger cross-button"
            ...
            {uploadedImages?.length > 0 && (
              <div className="mt-4 uploaded-images">
